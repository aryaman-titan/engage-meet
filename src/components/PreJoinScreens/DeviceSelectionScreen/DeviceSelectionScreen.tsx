...
const GetRandomLoader: React.FC = () => {
    let loaders = [
    ...
    if (isFetching || isConnecting) {
        return (
            <Grid container justify="center" alignItems="center" direction="column" style={{ height: '100%' }}>
                ...
                <Grid item style={{paddingTop: '10em',  paddingBottom: '4em'}}>
                    <Typography variant="body2" style={{ fontWeight: 'bold', fontSize: '26px' }}>
                        Joining Meeting...
                    </Typography>
                </Grid>
            </Grid>
